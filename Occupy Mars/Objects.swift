...
class Objects {
    ...
    static func planets() -> [Class: [Planet]] {
        ...
        Venus.display(texture: "venusmap.jpg", model: nil, normalmap: nil, ringmap: nil, ring_transparencymap: nil, ring_inner_ratio: nil, ring_outer_ratio: nil)
        Venus.orbitals(year_length: 224.701, perihelion: 107.48, aphelion: 108.94, velocity: 35.02, inclination: 3.39, eccentricity: 0.0067, day_length: 2802.0, equator_inclination: 177.36, min_distance_from_earth: 38.2, max_distance_from_earth: 261.0)
        ...
        Earth.orbitals(year_length: 224.701, perihelion: 107.48, aphelion: 108.94, velocity: 35.02, inclination: 3.39, eccentricity: 0.0067, day_length: 24.0, equator_inclination: 45.19, min_distance_from_earth: 38.2, max_distance_from_earth: 261.0)
        
        
        //----------------------------------------------------------------------------------------------
        let Mars = Planet(name: "Mars", type: Type.Rock, position: 4, classification: Class.Major)
        Mars.display(texture: "marsmap.jpg", model: nil, normalmap: "test_normal_map.jpg", ringmap: nil, ring_transparencymap: nil, ring_inner_ratio: nil, ring_outer_ratio: nil)
        ...
        Mars.orbitals(year_length: 400, perihelion: 100, aphelion: 120, velocity: 400, inclination: 25.19, eccentricity: 4, day_length: 24.66, equator_inclination: 25.19, min_distance_from_earth: 100, max_distance_from_earth: 600)
        Mars.images(images: [("mars - olympus mons.jpg", "test0"),
                     ("mars - landscape.jpg","test1"),
                     ("mars - pole.jpg", "test1.5"),
                     ("mars - frosted dunes.jpg", "test2"),
                     ("mars - valles marineris.png", "test3"),
                     ("mars - curiosity selfie.jpg", "test4")])
