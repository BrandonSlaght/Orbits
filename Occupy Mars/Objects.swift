...
class Objects {
    ...
    static func earth() -> Planet {
        ...
        moon.geology(mass: 73420000.exogram(),
...
//        Jupiter.moons.append(J1)
    ...
    static func ceres() -> Planet {
        ...
        Ceres.images = [
            ...
            ("ceres - occator.jpg", "The Occator crater on Ceres contains bright spots.  Some astronomers think these are salt deposits left over from brine coming to the surface of Ceres."),
            ("ceres - shadows.jpg", "Ceres is small enough (~950 km in diameter) for mountains and craters to change the horizon."),
    ...
    static func haumea() -> Planet {
        ...
        Hiiaka.geology(mass: 17900000.petagram(),
                       volume: nil,
                       equatorial: nil,
                       density: 1000.kilogram(),
                       gravity: nil,
    ...
    static func solarSystem() -> [Class: [Planet]] {
        [
            Class.Major: planets(),
            Class.Dwarf: dwarfPlanets(),
            Class.Other: other()
        ]
    }
    ...
    static func dwarfPlanets() -> [Planet] {
        [
            ceres(),
            pluto(),
            haumea(),
