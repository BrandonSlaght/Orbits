...
class Objects {
    ...
    static func planets() -> [Class: [Planet]] {
        ...
        Mars.about("Mars is a cold desert world. It is half the diameter of Earth and has the same amount of dry land. Like Earth, Mars has seasons, polar ice caps, volcanoes, canyons and weather, but its atmosphere is too thin for liquid water to exist for long on the surface. There are signs of ancient floods on Mars, but evidence for water now exists mainly in icy soil and thin clouds.", wiki: "https://wikipedia.org/wiki/Mars", nasa: "http://solarsystem.nasa.gov/planets/mars")
