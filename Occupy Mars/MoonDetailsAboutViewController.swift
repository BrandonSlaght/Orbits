...
class MoonDetailsAboutViewController: MoonsAboutViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        geology = moon.generateGeologyObjects()
        orbit = moon.generateOrbitalObjects()
        misc = moon.generateMiscObjects()
