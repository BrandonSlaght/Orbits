...
//        dispatch_after(
//            DispatchTime.now(dispatch_time_t(DISPATCH_TIME_NOW), Int64(0.2 * Double(NSEC_PER_SEC))),
//            DispatchQueue.main)
//        {
...
//        
//        handleSingleTap(touchPoint: CGPointMake(touchX, touchY))
//    }
//    
...
//        touchY += self.contentOffset.y
//        
//        handleDoubleTap(touchPoint: CGPointMake(touchX, touchY))
//    }
//    
